        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    className="w-full max-w-[280px] rounded-2xl bg-discord-card border border-cyber-neon/40 shadow-[0_0_40px_rgba(0,255,136,0.3)] overflow-hidden"
                >
                    {/* Glow effect */}
                    ...
                    <div className="relative px-6 pt-6 pb-4 text-center">
                        ...
                        <motion.div
                            ...
                            className="text-5xl font-black text-cyber-neon mb-3 drop-shadow-[0_0_20px_rgba(0,255,136,0.8)]"
                        >
                            Lv.{level}
                        </motion.div>
