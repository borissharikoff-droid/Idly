...
export function BackpackButton({ onClick, className = '' }: BackpackButtonProps) {
  return (
    <button
      ...
      className={`w-8 h-8 rounded bg-surface-2/60 border border-white/[0.06] flex items-center justify-center text-gray-400 hover:text-white hover:border-white/10 transition-colors focus:outline-none ${className}`}
      title="Backpack"
    >
