...
export function GoldDisplay() {
  ...
  return (
    <div className="flex items-center gap-1.5 px-3 py-1.5 rounded bg-amber-500/12 border border-amber-500/25">
      ...
      <span className="text-sm font-bold text-amber-400 tabular-nums">{fmt(gold ?? 0)}</span>
    </div>
  )
}
