...
export const CRAFT_LOOT_ITEMS: LootItemDef[] = [
  ...
  },
  {
    ...
    rarity: 'rare',
    icon: '🐺',
    image: 'loot/item_craft_wolf_pendant.png',
  ...
  },
  {
    ...
    perkType: 'atk_boost',
    perkValue: 12,
    perkDescription: '+12 ATK · +40 HP · +4 DEF',
    perks: [
  ...
  // ── Zone 7 — Lich Set (Mythic, Shadow Crypt) ────────────────────────────────
  // Full set: +83 ATK, +380 HP, +13 HP Regen, +8 DEF — meets zone 7 requirements
  {
    ...
    rarity: 'mythic',
    icon: '💀',
    image: 'loot/item_craft_lich_helm.png',
  ...
  },
  {
    ...
    rarity: 'mythic',
    icon: '🛡️',
    image: 'loot/item_craft_lich_plate.png',
  ...
  },
  {
    ...
    rarity: 'mythic',
    icon: '⚔️',
    image: 'loot/item_craft_lich_sword.png',
  ...
  },
  {
    ...
    rarity: 'mythic',
    icon: '🦿',
    image: 'loot/item_craft_lich_legs.png',
  ...
  },
  {
    ...
    rarity: 'mythic',
    icon: '💎',
    image: 'loot/item_craft_lich_ring.png',
  ...
  // Full set: +107 ATK, +500 HP, +18 HP Regen, +15 DEF — meets zone 8 requirements
  {
    ...
    rarity: 'mythic',
    icon: '⚡',
    image: 'loot/item_craft_titan_helm.png',
  ...
  },
  {
    ...
    rarity: 'mythic',
    icon: '🌩️',
    image: 'loot/item_craft_titan_plate.png',
  ...
  },
  {
    ...
    rarity: 'mythic',
    icon: '⚡',
    image: 'loot/item_craft_titan_sword.png',
  ...
  },
  {
    ...
    rarity: 'mythic',
    icon: '🦿',
    image: 'loot/item_craft_titan_legs.png',
  ...
  },
  {
    ...
    rarity: 'mythic',
    icon: '🔮',
    image: 'loot/item_craft_titan_ring.png',
  ...
  // ── Mythic boss-material gear ───────────────────────────────────────────────
  {
    ...
    rarity: 'epic',
    icon: '🔱',
    image: 'loot/item_craft_warlord_gauntlets.png',
  ...
  },
  {
    ...
    perkType: 'atk_boost',
    perkValue: 24,
    perkDescription: '+24 ATK · +20 HP · +6 HP Regen/s',
    perks: [
      { perkType: 'atk_boost', perkValue: 24, perkDescription: '+24 ATK' },
      { perkType: 'hp_boost', perkValue: 20, perkDescription: '+20 HP' },
      { perkType: 'hp_regen_boost', perkValue: 6, perkDescription: '+6 HP Regen/s' },
