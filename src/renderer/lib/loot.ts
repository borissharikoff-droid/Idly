...
export const CHEST_DEFS: Record<ChestType, ChestDef> = {
  ...
  epic_chest: {
    ...
    itemWeights: [
      ...
      { itemId: 'golden_helm',   weight: 1 },
      { itemId: 'golden_plate',  weight: 1 },
      { itemId: 'golden_sword',  weight: 1 },
      { itemId: 'golden_legs',   weight: 1 },
      { itemId: 'golden_ring',   weight: 1 },
  ...
  legendary_chest: {
    ...
    itemWeights: [
      ...
      { itemId: 'void_helm',        weight: 2 },
      { itemId: 'void_plate',       weight: 2 },
      { itemId: 'void_sword',       weight: 2 },
      { itemId: 'void_legs',        weight: 2 },
      { itemId: 'void_ring',        weight: 2 },
