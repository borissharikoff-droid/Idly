...
export const LOOT_ITEMS: LootItemDef[] = [
  ...
  { id: 'wooden_ring',    name: 'Wooden Ring',    slot: 'ring',   rarity: 'common', icon: '📿', description: 'A whittled ring with faint natural energy.',       perkType: 'hp_regen_boost', perkValue: 0.5, perkDescription: '+0.5 HP Regen' },
  // Rare — Copper Set
  ...
  { id: 'copper_legs',    name: 'Copper Legs',    slot: 'legs',   rarity: 'rare',   icon: '🦿', description: 'Copper greaves forged for agility.',               perkType: 'atk_boost',      perkValue: 2,   perkDescription: '+2 ATK' },
  { id: 'copper_ring',    name: 'Copper Ring',    slot: 'ring',   rarity: 'rare',   icon: '💍', description: 'A copper band humming with warmth.',               perkType: 'hp_regen_boost', perkValue: 1.5, perkDescription: '+1.5 HP Regen' },
  // Epic — Shadow Set
  { id: 'shadow_helm',    name: 'Shadow Helm',    slot: 'head',   rarity: 'epic',   icon: '🪖', description: 'A helm wreathed in living shadow.',                perkType: 'atk_boost', perkValue: 7, perkDescription: '+7 ATK',
    perks: [{ perkType: 'atk_boost', perkValue: 7, perkDescription: '+7 ATK' }, { perkType: 'hp_boost', perkValue: 15, perkDescription: '+15 HP' }] },
  { id: 'shadow_plate',   name: 'Shadow Plate',   slot: 'body',   rarity: 'epic',   icon: '🛡️', description: 'Dark armor that absorbs incoming strikes.',       perkType: 'hp_boost', perkValue: 50, perkDescription: '+50 HP',
  ...
  { id: 'shadow_legs',    name: 'Shadow Legs',    slot: 'legs',   rarity: 'epic',   icon: '🦿', description: 'Greaves that let you move like a phantom.',        perkType: 'atk_boost', perkValue: 5, perkDescription: '+5 ATK',
    perks: [{ perkType: 'atk_boost', perkValue: 5, perkDescription: '+5 ATK' }, { perkType: 'hp_boost', perkValue: 20, perkDescription: '+20 HP' }] },
  { id: 'shadow_ring',    name: 'Shadow Ring',    slot: 'ring',   rarity: 'epic',   icon: '🔗', description: 'A ring pulsing with dark energy.',                 perkType: 'atk_boost', perkValue: 5, perkDescription: '+5 ATK',
  ...
  // Legendary — Golden Set
  { id: 'golden_helm',    name: 'Golden Helm',    slot: 'head',   rarity: 'legendary', icon: '👑', description: 'A crown-helm of pure gold. Radiates power.',    perkType: 'atk_boost', perkValue: 8, perkDescription: '+8 ATK',
    perks: [{ perkType: 'atk_boost', perkValue: 8, perkDescription: '+8 ATK' }, { perkType: 'hp_boost', perkValue: 30, perkDescription: '+30 HP' }, { perkType: 'xp_global_boost', perkValue: 0.05, perkDescription: '+5% Global XP' }] },
  ...
  { id: 'golden_sword',   name: 'Golden Sword',   slot: 'weapon', rarity: 'legendary', icon: '⚔️', description: 'A blade of gleaming gold. Strikes true.',     perkType: 'atk_boost', perkValue: 12, perkDescription: '+12 ATK',
    perks: [{ perkType: 'atk_boost', perkValue: 12, perkDescription: '+12 ATK' }, { perkType: 'hp_regen_boost', perkValue: 3, perkDescription: '+3 HP Regen' }] },
  { id: 'golden_legs',    name: 'Golden Legs',    slot: 'legs',   rarity: 'legendary', icon: '🦿', description: 'Golden greaves that bolster the wearer.',       perkType: 'atk_boost', perkValue: 7, perkDescription: '+7 ATK',
    perks: [{ perkType: 'atk_boost', perkValue: 7, perkDescription: '+7 ATK' }, { perkType: 'hp_boost', perkValue: 40, perkDescription: '+40 HP' }] },
  { id: 'golden_ring',    name: 'Golden Ring',    slot: 'ring',   rarity: 'legendary', icon: '💍', description: 'A ring of ancient kings. Sharpens focus.',      perkType: 'atk_boost', perkValue: 6, perkDescription: '+6 ATK',
    perks: [{ perkType: 'atk_boost', perkValue: 6, perkDescription: '+6 ATK' }, { perkType: 'focus_boost', perkValue: 0.15, perkDescription: '+15% Focus' }] },
  // Mythic — Void Set
  { id: 'void_helm',      name: 'Void Helm',      slot: 'head',   rarity: 'mythic', icon: '🌀', description: 'A helm torn from the void itself.',               perkType: 'atk_boost', perkValue: 12, perkDescription: '+12 ATK',
    perks: [{ perkType: 'atk_boost', perkValue: 12, perkDescription: '+12 ATK' }, { perkType: 'hp_boost', perkValue: 50, perkDescription: '+50 HP' }, { perkType: 'xp_global_boost', perkValue: 0.08, perkDescription: '+8% Global XP' }] },
  ...
  { id: 'void_sword',     name: 'Void Sword',     slot: 'weapon', rarity: 'mythic', icon: '⚔️', description: 'A blade of pure void energy. Unmatchable.',       perkType: 'atk_boost', perkValue: 15, perkDescription: '+15 ATK',
    perks: [{ perkType: 'atk_boost', perkValue: 15, perkDescription: '+15 ATK' }, { perkType: 'hp_regen_boost', perkValue: 5, perkDescription: '+5 HP Regen' }] },
  { id: 'void_legs',      name: 'Void Legs',      slot: 'legs',   rarity: 'mythic', icon: '🦿', description: 'Greaves that phase through attacks.',              perkType: 'atk_boost', perkValue: 10, perkDescription: '+10 ATK',
    perks: [{ perkType: 'atk_boost', perkValue: 10, perkDescription: '+10 ATK' }, { perkType: 'hp_boost', perkValue: 60, perkDescription: '+60 HP' }] },
