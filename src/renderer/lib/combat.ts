...
export const ZONES: ZoneDef[] = [
  // ── Zone 1 — Slime Cavern (target: partial Wooden → ~8 ATK, 100 HP; full Wooden → 11/115/1) ──
  {
    ...
    mobs: [
      { id: 'slime_scout',  name: 'Slime Scout',  icon: '🫧', hp: 80,    atk: 1.5, xpReward: 15,    goldMin: 8,   goldMax: 18,   materialDropId: 'slime_gel', materialDropChance: 0.3 },
      { id: 'slime_guard',  name: 'Slime Guard',  icon: '🫧', hp: 150,   atk: 2,   xpReward: 25,    goldMin: 12,  goldMax: 25,   materialDropId: 'slime_gel', materialDropChance: 0.4 },
      { id: 'slime_brute',  name: 'Slime Brute',  icon: '🫧', hp: 250,   atk: 3,   xpReward: 40,    goldMin: 18,  goldMax: 35,   materialDropId: 'slime_gel', materialDropChance: 0.5 },
    ],
    boss: {
  ...
  // ── Zone 3 — Wild Forest (target: Copper set → 18 ATK, 155 HP, 2 Regen; rewards Shadow gear) ────
  {
    ...
    mobs: [
      { id: 'wolf_young', name: 'Young Wolf',  icon: '🐺', hp: 350,   atk: 3.5, def: 1, xpReward: 150,   goldMin: 20,  goldMax: 40,   materialDropId: 'wolf_fang', materialDropChance: 0.3 },
      { id: 'wolf_pack',  name: 'Pack Wolf',   icon: '🐺', hp: 500,   atk: 4.5, def: 2, xpReward: 250,   goldMin: 30,  goldMax: 55,   materialDropId: 'wolf_fang', materialDropChance: 0.4 },
      { id: 'wolf_alpha', name: 'Alpha Wolf',  icon: '🐺', hp: 650,   atk: 5.5, def: 3, xpReward: 400,   goldMin: 45,  goldMax: 80,   materialDropId: 'wolf_fang', materialDropChance: 0.5 },
    ],
    boss: {
      id: 'wolf', name: 'Forest Wolf', icon: '🐺', hp: 750, atk: 5.5, def: 3,
      rewards: { chestTier: 'epic_chest' },
      requirements: { minAtk: 14, minHp: 140 },
  ...
  // ── Zone 5 — Troll Bridge (target: Golden set → 49 ATK, 250 HP, 7 Regen) ───
  {
    ...
    mobs: [
      { id: 'troll_bridge', name: 'Bridge Troll', icon: '🧌', hp: 1500,  atk: 8,    def: 4, xpReward: 3000,  goldMin: 150, goldMax: 250,  materialDropId: 'troll_hide', materialDropChance: 0.3, materialDropQty: 2 },
      { id: 'troll_stone',  name: 'Stone Troll',  icon: '🧌', hp: 2200,  atk: 9,    def: 6, xpReward: 5000,  goldMin: 200, goldMax: 350,  materialDropId: 'troll_hide', materialDropChance: 0.4, materialDropQty: 3 },
      { id: 'troll_ancient',name: 'Ancient Troll', icon: '🧌', hp: 3000,  atk: 10,   def: 7, xpReward: 7500,  goldMin: 280, goldMax: 450,  materialDropId: 'troll_hide', materialDropChance: 0.5, materialDropQty: 3 },
    ],
    boss: {
      id: 'troll', name: 'Troll Overlord', icon: '🧌', hp: 3200, atk: 10.5, def: 8, atkSpread: 0.25,
      rewards: { chestTier: 'epic_chest' },
  ...
  // ── Zone 6 — Dragon Lair (target: Void set → 67 ATK, 330 HP, 10 Regen + warrior bonuses)
  {
    ...
    mobs: [
      { id: 'dragon_whelp',  name: 'Dragon Whelp',  icon: '🐉', hp: 2200,  atk: 12,   def: 6,  atkSpread: 0.3, xpReward: 10000, goldMin: 200,  goldMax: 350,  materialDropId: 'dragon_scale', materialDropChance: 0.3, materialDropQty: 2 },
      { id: 'dragon_guard',  name: 'Dragon Guard',  icon: '🐉', hp: 3200,  atk: 13,   def: 8,  atkSpread: 0.3, xpReward: 18000, goldMin: 280,  goldMax: 450,  materialDropId: 'dragon_scale', materialDropChance: 0.4, materialDropQty: 3 },
      { id: 'dragon_elder',  name: 'Elder Dragon',  icon: '🐉', hp: 4200,  atk: 14.5, def: 10, atkSpread: 0.3, xpReward: 28000, goldMin: 350,  goldMax: 500,  materialDropId: 'dragon_scale', materialDropChance: 0.5, materialDropQty: 4 },
    ],
    boss: {
      id: 'dragon', name: 'Ancient Dragon', icon: '🐉', hp: 4800, atk: 15, def: 12, atkSpread: 0.35,
